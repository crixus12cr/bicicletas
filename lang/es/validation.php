...
return [
    ...
    */
    ...
    'digits'               => 'El campo :attribute debe ser un dígito de :digits dígitos.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos de Validación Personalizados (Nombres de campos)
    |--------------------------------------------------------------------------
    */
    'attributes' => [
        'name'                      => 'nombre',
        ...
        'activo'                    => 'activo',
        'selectedRoles'             => 'roles',
        'descripcion_bicicleta'     => 'descripción de la bicicleta',
        'notas'                     => 'notas',
        ...
        'addonDescripcion'          => 'descripción del añadido',
        'addonCosto'                => 'costo del añadido',
        // Campos del modal de creación
        'newNombreCliente'          => 'nombre del cliente',
        'newTelefonoCliente'        => 'teléfono del cliente',
        'newEmailCliente'           => 'correo electrónico del cliente',
        'newDescripcionBicicleta'   => 'descripción de la bicicleta',
        'newFechaEntrega'           => 'fecha estimada de entrega',
        'newPrecioBase'             => 'precio base',
        'newMecanicoId'             => 'mecánico asignado',
        'newNotas'                  => 'notas adicionales',
    ],
];